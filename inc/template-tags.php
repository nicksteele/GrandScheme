...
function grandscheme_posted_on() {
	if ( is_sticky() ) {
		printf( __( '<a href="%1$s" title="%2$s" rel="bookmark">%3$s</a><span class="byline"><span class="sep"> | </span><span class="author vcard"><a class="url fn n" href="%4$s" title="%5$s" rel="author">%6$s</a></span></span>', 'grandscheme' ),
		...
		printf( __( '<a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s" pubdate>%4$s</time></a><span class="byline"><span class="sep"> | </span><span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span></span>', 'grandscheme' ),
			esc_url( get_permalink() ),
			esc_attr( get_the_time() ),
