					...
					<header class="entry-header">
						...
						<div class="entry-meta">
							<?php
								...
								printf( __( 'Published: <span class="entry-date"><time class="entry-date" datetime="%1$s" pubdate>%2$s</time></span><br />Full size: <a href="%3$s" title="Link to full-size image">%4$s &times; %5$s</a><br />Attached: <a href="%6$s" title="Return to %7$s" rel="gallery">%7$s</a>', 'grandscheme' ),
							...
							?>
							<br /><?php edit_post_link( __( 'Edit', 'grandscheme' ), '<span class="edit-link">', '</span>' ); ?>
							<nav id="image-navigation">
								<span class="previous-image"><?php previous_image_link( false, __( '&laquo;' , 'grandscheme' ) ); ?></span>
								<span class="previous-image-thumb"><?php previous_image_link( 'thumbnail' ); ?></span>
								<span class="next-image"><?php next_image_link( false, __( '&raquo;' , 'grandscheme' ) ); ?></span>
